...
import { closeModal, addNotification, NotificationType } from '../../store/slices/uiSlice';
import { RootState, AppDispatch } from '../../store';
import Modal from '../ui/Modal';
import Input from '../ui/Input';
import Button from '../ui/Button';

// Sample regions data - should come from API in production
const REGIONS = [
...
const CreateIssueModal: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (createIssue.fulfilled.match(resultAction)) {
        ...
        dispatch(closeModal('createIssue'));
  ...
  const handleClose = () => {
    // Release the object URLs to avoid memory leaks
